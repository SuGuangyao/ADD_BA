...
def main():
    ...
    parser.add_argument('--root_path', type=str, default='./data/air/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='air.csv', help='data file')
